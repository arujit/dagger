...
//        finalRecord.setField(finalRecord.getArity() - 1, LocalDateTime.from(Instant.ofEpochSecond(timestampSeconds, timestampNanos)));
//        finalRecord.setField(finalRecord.getArity() - 1, timestampSeconds);
        return finalRecord;
    }
}
